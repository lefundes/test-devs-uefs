...
<head>
    ...
    <title>UEFS Netra - Dashboard</title>
    ...
    <div class="flex h-screen">
        ...
        <div class="sidebar bg-white w-64 shadow-lg">
            ...
            <nav class="mt-6">
                ...
                <a href="javascript:void(0)" onclick="showDevelopmentAlert('Usuários')" class="nav-link flex items-center px-6 py-3 text-gray-700 {{ request()->routeIs('users.*') ? 'active' : '' }}">
